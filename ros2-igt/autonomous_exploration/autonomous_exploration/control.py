...
with open("ros2-igt/autonomous_exploration/config/params.yaml", 'r') as file:
        ...
        while True:
            ...
            if self.kesif == True:
                ...
                if v == None:
                    ...
                    # print(abs(self.x - self.path[-1][0]),abs(self.y - self.path[-1][1]))
